-- ⚠️ SUPERSEDED — 本脚本（ALTER TABLE medical_record ADD COLUMN source）已被废除。
--   v2.2 改为新建 medical_record_meta 表承载 source + AI 快照，不修改旧业务表结构。
--   本文件保留仅供历史追溯，禁止在任何环境执行。
--   ALTER 旧业务表行为与 v2.0 "零 ALTER" 约束冲突，已移除。
-- ============================================================
-- 东软智慧云脑诊疗平台 - 增量脚本 v1.3 [已废除]
-- medical_record 增加 source 列（病历来源）[已由 v2.2 medical_record_meta 替代]
-- ============================================================
